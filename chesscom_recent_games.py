    ...
    if error:
        ...
        for game in result.get("games", []):
            ...
            cards.append(
                ...
                "<ul>"
                f"<li>Opening: {stage['opening']['score']} ({stage['opening']['grade']})</li>"
                f"<li>Midgame: {stage['midgame']['score']} ({stage['midgame']['grade']})</li>"
                f"<li>Endgame: {stage['endgame']['score']} ({stage['endgame']['grade']})</li>"
                "</ul>"
